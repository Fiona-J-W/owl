...
build/html_gen.o: src/html_gen.cpp src/assignment.hpp src/database.hpp src/html_gen.hpp src/id.hpp src/reference.hpp src/solution.hpp src/student.hpp src/task.hpp makefile
